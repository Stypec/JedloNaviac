...
<template>
  <section id="pre-farmarov" class="py-20 bg-background">
    <div class="container mx-auto px-4">
      ...
      <p class="text-center text-muted-foreground mb-10 max-w-xl mx-auto font-body">
      ...
      <div class="max-w-lg mx-auto bg-card rounded-2xl p-8 shadow-card border border-border">
        ...
        <form v-else @submit.prevent="handleSubmit" class="space-y-5">
          <div>
            <label class="font-body text-sm font-medium text-foreground block mb-1.5">Meno</label>
            <input
              v-model="form.name"
              type="text"
          ...
          <div>
            <label class="font-body text-sm font-medium text-foreground block mb-1.5">Email</label>
            <input
              v-model="form.email"
              type="email"
              class="w-full px-4 py-3 rounded-lg border border-input bg-background font-body text-foreground focus:outline-none focus:ring-2 focus:ring-ring"
          ...
          <div>
            <label class="font-body text-sm font-medium text-foreground block mb-1.5">Správa</label>
            <textarea
            ...
            />
            <p v-if="errors.message" class="text-destructive text-sm mt-1">{{ errors.message }}</p>
          </div>
          <button
            type="submit"
